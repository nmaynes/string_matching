...
if __name__ == '__main__':
    name_pairs = [
        ...
        ('honorable rabbi krustofsky', 'Rabbi Hyman Krustofsky'),
    ...
    for np in name_pairs:
        ...
        hamming = compare_hamming(first, second)
        ratio_dist = compare_ratio(first, second)
        ...
        print('{:25} | {:25}'.format('Hamming Distance', hamming, align='right'))
        print('{:25} | {:25.2%}'.format('Ratio Distance', ratio_dist, align='right'))
